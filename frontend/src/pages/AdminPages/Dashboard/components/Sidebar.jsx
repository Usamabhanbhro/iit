...
const Sidebar = ({ activeTab, setActiveTab, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-64 bg-[#020B18]/80 backdrop-blur-xl border-r border-white/10 flex-col flex-shrink-0 h-screen sticky top-0">
      ...
      >
        ...
        {/* Sidebar panel */}
        <aside 
          className={`absolute top-0 left-0 w-64 h-full bg-[#020B18]/95 backdrop-blur-xl border-r border-white/10 transform transition-transform duration-300 ease-in-out ${
