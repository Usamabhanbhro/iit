...
import { SiNextdotjs, SiTypescript, SiFlutter, SiKotlin, SiPytorch, SiTensorflow, SiKubernetes, SiN8N } from 'react-icons/si'
...
const stacks = {
  ...
  Mobile: [
    ...
    { name: "Java", color: "#dc440d", icon: <FaJava /> },
  ],
  "Cloud & DevOps": [
  ...
  "AI / ML": [
    ...
    { name: "n8n", color: "#d44a00", icon: <SiN8N /> },
  ],
}
const TechStack = () => {
  return (
    <>
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <p className="text-center text-md font-bold text-indigo-600 uppercase tracking-widest mb-2">Technologies We Use</p>
